...
| Identité | FancyMenu, Konkrete, Melody | Écran-titre personnalisé (fond et boutons Tidebound) ; Konkrete et Melody sont des librairies requises par FancyMenu, mods client uniquement |
