# Tidebound — Into the Deep (Devpack 0.35.0-alpha)
...
`tidebound-0.35.0-alpha.jar` dans le dossier `mods` de l'instance.

Le workflow GitHub Actions automatise cette étape : son artifact contient
`Tidebound_Devpack_0.35.0-alpha.zip`, directement importable dans CurseForge, ainsi que le JAR seul.
