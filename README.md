...
- version du projet : `0.13.0-alpha` ;
- dernier ticket terminé : `TB-DESIGN-002` ;
...
Le JAR attendu est `core/build/libs/tidebound-0.13.0-alpha.jar`. Le workflow GitHub Actions publie
